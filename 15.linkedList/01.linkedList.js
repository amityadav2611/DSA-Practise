...
A linked list is an ordered collection of data elements. A data element can be represented
as a node in a linked list. Each node consists of two parts: data & pointer to the next node.
...
//-----------------------------------------4. removeElement(element)----------------------------
    //This method removes element from the list. It returns the removed element,
